function [BCModel_StalkCellDensity, BCModel_TipCellDensity, Omega, TimeMesh] = SnailTrail_1D_PDE_OuterSoln(TC_InitCond, EC_InitCond)
...
% Space-Time Domain:
Omega = linspace(0, 10, 2001)'; % X-Coordinates
TimeMesh = 0.2:1/160:20;
N = length(Omega);
Dx = Omega(2);
...
h = 1/200;
dcdx = 1; C0 = 0;
beta_n = 160; chi = beta_n*k*h^2; D = beta_n*h^2/4;
...
N_N = spdiags([(D/Dx/Dx+chi/2/Dx)*e,...
