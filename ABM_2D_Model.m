...
%--------------------------------------------------------------------------
%% Name Solution Files
filename = '9jul2020_PillayCAModel_Fixed_P_p5e-2_P_m1_k100';
% filename = 'ABM_Data';
...
Parameters.P_p = 5e-2; % Probability of branching (note: proportional to TAF concentration also)
...
Parameters.a_n = true; % Does Tip-to-Tip Anastomosis Occur? (Binary)
Parameters.a_e = true; % Does Tip-to-Sprout Anastomosis Occur? (Binary)
...
PerfusedNetworks = Example_PerfusedNetworks;
TC_Solution = Example_TC_Solution;
EC_Solution = Example_EC_Solution;
